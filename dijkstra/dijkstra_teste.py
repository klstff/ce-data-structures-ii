...
from dijkstra import Grafo, Vertice, DistanciaVerticeOrigem
...
class TestConexoes(unittest.TestCase):
    def setUp(self):
        self.grafo = Grafo()

        self.grafo.adiciona_vertice("Belo Horizonte")
        self.grafo.adiciona_vertice("Sao Paulo")
        self.grafo.adiciona_vertice("Campinas")
        self.grafo.adiciona_vertice("Rio de Janeiro")

        self.grafo.adiciona_aresta("Belo Horizonte","Sao Paulo", 1)
        self.grafo.adiciona_aresta("Belo Horizonte","Campinas", 1)
        self.grafo.adiciona_aresta("Belo Horizonte","Rio de Janeiro", 1)
        self.grafo.adiciona_aresta("Campinas","Sao Paulo", 1)
        self.grafo.adiciona_aresta("Sao Paulo","Rio de Janeiro", 1)

    def test_dijkstra(self):
        cidade_origem = "Belo Horizonte"
        distancias, pais = self.grafo.dijkstra(cidade_origem)
        
        for i in distancias.keys():
            print("Menor número de conexões de", cidade_origem, "até", i.valor, ":", distancias[i].distancia)
...
class TestValor(unittest.TestCase):
    def setUp(self):
        ...
        self.grafo.adiciona_aresta("Belo Horizonte","Sao Paulo", 150)
        self.grafo.adiciona_aresta("Belo Horizonte","Campinas", 50)
        self.grafo.adiciona_aresta("Belo Horizonte","Rio de Janeiro", 300)
        self.grafo.adiciona_aresta("Campinas","Sao Paulo", 40)
        self.grafo.adiciona_aresta("Sao Paulo","Rio de Janeiro", 90)

    def test_dijkstra(self):
        cidade_origem = "Belo Horizonte"
        precos, pais = self.grafo.dijkstra(cidade_origem)
        
        for i in precos.keys():
            print("Menor preço de", cidade_origem, "até", i.valor, ":", precos[i].distancia)
